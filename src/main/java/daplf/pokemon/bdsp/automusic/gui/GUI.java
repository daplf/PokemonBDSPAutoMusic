...
import daplf.pokemon.bdsp.automusic.game.state.routes.AcuityCavernState;
...
import daplf.pokemon.bdsp.automusic.game.state.routes.LakeAcuityState;
...
import daplf.pokemon.bdsp.automusic.game.state.routes.Route227State;
...
import daplf.pokemon.bdsp.automusic.game.state.routes.StarkMountainCaveState;
import daplf.pokemon.bdsp.automusic.game.state.routes.StarkMountainState;
import daplf.pokemon.bdsp.automusic.game.state.routes.ValleyWindworksState;
import daplf.pokemon.bdsp.automusic.game.state.routes.ValorCavernState;
import daplf.pokemon.bdsp.automusic.game.state.routes.ValorLakefrontState;
import daplf.pokemon.bdsp.automusic.game.state.routes.VerityCavernState;
...
public class GUI extends Application {
    ...
    private static final List<MapLocationButton> MAP_BUTTONS = List.of(
        ...
        new MapLocationButton("Lake\nVerity", LakeVerityState::new, 20, 755, 70, 40),
        new MapLocationButton("Verity\nCavern", VerityCavernState::new, 20, 710, 70, 40),
        ...
        new MapLocationButton("Valor\nCavern", ValorCavernState::new, 825, 660, 70, 40),
        new MapLocationButton("Route\n213", Route213State::new, 935, 730, 120, 40),
        new MapLocationButton("Pastoria\nCity", PastoriaCityState::new, 855, 730, 70, 40),
        new MapLocationButton("Route\n212", Route212State::new, 705, 660, 60, 110),
        new MapLocationButton("Route\n212", Route212State::new, 775, 730, 70, 40),
        ...
        new MapLocationButton("Lake\nAcuity", LakeAcuityState::new, 430, 130, 70, 40),
        new MapLocationButton("Acuity\nCavern", AcuityCavernState::new, 430, 80, 70, 40),
        ...
        new MapLocationButton("Fight\nArea", FightAreaState::new, 810, 230, 80, 40),
        new MapLocationButton("Route\n225", Route225State::new, 810, 185, 80, 40),
        new MapLocationButton("Survival\nArea", SurvivalAreaState::new, 900, 185, 80, 40),
        new MapLocationButton("Route\n226", Route226State::new, 990, 185, 80, 40),
        new MapLocationButton("Route\n227", Route227State::new, 990, 140, 80, 40),
        new MapLocationButton("Stark\nMountain", StarkMountainState::new, 990, 95, 80, 40),
        new MapLocationButton("Stark\nMountain\nCave", StarkMountainCaveState::new, 990, 20, 80, 70),
