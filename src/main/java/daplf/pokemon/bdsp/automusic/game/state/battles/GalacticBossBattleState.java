...
public class GalacticBossBattleState extends BattleState {

    private final Supplier<State> postBattleStateSupplier;

    public GalacticBossBattleState(final Supplier<State> postBattleStateSupplier) {
    ...
    public Songs getSong() {
        return Songs.BATTLE_GALACTIC_BOSS;
    }
