...
public class GalacticCommanderBattleState extends BattleState {

    private final Supplier<State> postBattleStateSupplier;

    public GalacticCommanderBattleState(final Supplier<State> postBattleStateSupplier) {
    ...
    public Songs getSong() {
        return Songs.BATTLE_GALACTIC_COMMANDER;
    }
